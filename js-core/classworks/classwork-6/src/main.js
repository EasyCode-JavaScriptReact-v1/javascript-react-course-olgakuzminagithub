...
// const newArr = [];
// listOfCompanys.forEach(function(company){
//     const companyIndex = company.index;
//     // console.log(company.index);
//     const megaObjectFriends = megaObject.friends;
//     // console.log(megaObjectFriends);
//     megaObjectFriends.forEach(function (friends, friendsIndex, arr) {
...
//     return elem.englishLevel <= user.english;
//
// });
//
// console.log(newArr);
...
const sum = arr.reduce(function (newValue, value, index, arr) {
